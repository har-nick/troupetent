...
import com.harnick.troupetent.library.domain.use_cases.GetBandcampCollectionItemsUseCase
import com.harnick.troupetent.library.domain.use_cases.GetBandcampCollectionSummaryUseCase
...
class LibraryViewModel @Inject constructor(
	private val getBandcampCollectionSummaryUseCase: GetBandcampCollectionSummaryUseCase,
	private val getBandcampCollectionItemsUseCase: GetBandcampCollectionItemsUseCase
) : ViewModel() {
...
//		getBandcampCollectionSummaryUseCase().onEach { emission ->
//			when (emission) {
//				is Fetching -> {
//					state = state.copy(
...
//		getBandcampCollectionItemsUseCase(summary).onEach { emission ->
//			when (emission) {
//				is Loading -> {
//					state = state.copy(
