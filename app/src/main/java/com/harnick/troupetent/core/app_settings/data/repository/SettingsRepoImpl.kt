...
class SettingsRepoImpl @Inject constructor(
	...
	override fun loadSettings(): Flow<AppSettings> = settingsDao.loadSettings()
	
	override suspend fun updateSettings(appSettings: AppSettings) = settingsDao.updateSettings(appSettings)
}